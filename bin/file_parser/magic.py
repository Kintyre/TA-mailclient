...
if os.path.isdir(bin_dist_path):
    if sys.platform == 'darwin':
        bin_dist_path = os.path.abspath(os.path.join(bin_dist_path, sys.platform))
        dll = os.path.abspath(os.path.join(bin_dist_path, 'libmagic.dylib'))
    elif sys.platform == 'win32':
        if sys.maxsize > 2**32:
            bin_dist_path = os.path.abspath(os.path.join(bin_dist_path, 'win64'))
        else:
            bin_dist_path = os.path.abspath(os.path.join(bin_dist_path, 'win32'))
